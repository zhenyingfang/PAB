...
class ResizeMultiDataset:
    def __init__(
        ...
        super(ResizeMultiDataset, self).__init__()
    ...
    def _get_text_proto(self):
        ...
        for _cls_name in self.class_map:
            ...
            self.text_proto.append(text_features)
        self.text_proto = torch.cat(self.text_proto)
