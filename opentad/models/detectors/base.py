    ...
    def forward(
        ...
        **kwargs
        ...
        if return_loss:
            ...
            return self.forward_detection(inputs, masks, metas, infer_cfg, post_cfg, gt_segments=gt_segments, gt_labels=gt_labels, **kwargs)

    def forward_detection(self, inputs, masks, metas, infer_cfg, post_cfg, gt_segments=None, gt_labels=None, **kwargs):
        ...
        if infer_cfg.load_from_raw_predictions:  # easier and faster to tune the hyper parameter in postprocessing
            ...
            predictions = self.forward_test(inputs, masks, metas, infer_cfg, gt_segments=gt_segments, gt_labels=gt_labels, **kwargs)
