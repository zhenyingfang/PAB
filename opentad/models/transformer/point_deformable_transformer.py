...
class PointDeformableDETRTransformer(nn.Module):
    def __init__(
        self,
        ...
        if self.as_two_stage:
            ...
            self.tgt_embed = nn.Embedding(two_stage_num_proposals, self.encoder.embed_dim)
            self.refpoint_embed = nn.Embedding(two_stage_num_proposals, 2)
