...
class OmniDeclsTransformer(OmniDeformableDETRTransformer):
    def __init__(
        self,
        num_proposals,
        num_classes,
        ...
        super(OmniDeclsTransformer, self).__init__(
    ...
    def forward_train(self, x, masks, gt_segments=None, gt_labels=None, decls_labels=None, is_training=True, **kwargs):
        ...
        if is_training:
            ...
            decoupled_scores = self.decoupled_cls(
                input_features=feat,
            )
        ...
        if is_training:
            ...
            detr_loss = self.losses(output, masks, gt_segments, gt_labels)
